...
export type ForecastSource = "tempest" | "sager" | "zambretti";
    ...
    const loadSettings = async () => {
      try {
        ...
        const merged: AppSettings = {
          ...
          distanceUnit: (displaySettings.distance_unit || localStorage.getItem("distanceUnit") || "km") as DistanceUnit,
          preferredForecastSource: (displaySettings.preferred_forecast_source || "tempest") as ForecastSource,
  ...
  const updateSettings = useCallback(async (newSettings: Partial<AppSettings>) => {
    ...
    try {
      ...
      const apiPayload = {
        ...
        ...(newSettings.distanceUnit !== undefined && { distance_unit: newSettings.distanceUnit }),
      ...
      if (newSettings.distanceUnit) {
        localStorage.setItem("distanceUnit", newSettings.distanceUnit);
      }
