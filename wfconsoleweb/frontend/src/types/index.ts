...
export interface DisplaySettings {
  ...
  rainfall_unit: "mm" | "in";
  distance_unit: "km" | "mi";
  preferred_forecast_source: "tempest" | "sager" | "zambretti";
...
export interface ZambrettiForecastResponse {
  source: "zambretti";
  error?: string;
  zambrettiNumber: number | null;
  forecastText: string;
  pressureTrend: "rising" | "steady" | "falling" | "unknown";
  pressureMb: number | null;
  pressureDelta3hMb: number | null;
