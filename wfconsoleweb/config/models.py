...
from wfconsoleweb.config.encryption import encrypt_value, decrypt_value
...
class DisplaySettings(Base):
    ...
    preferred_forecast_source = Column(String(16), default="tempest")  # tempest, sager, zambretti
