...
from wfpiconsole.core.observation_parser import get_parser
    ...
    async def _handle_packet(self, data: bytes, addr: tuple) -> None:
        ...
        try:
            ...
            observation = Observation(
                ...
                wind_gust_mps=parsed.get("wind_gust_mps"),
                wind_direction_deg=parsed.get("wind_direction_deg"),
                rainfall_mm=parsed.get("rainfall_mm"),
                solar_radiation_wm2=parsed.get("solar_radiation_wm2"),
                uv_index=parsed.get("uv_index"),
                lightning_strike_count=parsed.get("lightning_strike_count"),
                lightning_strike_last_distance_km=parsed.get("lightning_strike_last_distance_km"),
